...
require (
	...
	github.com/cockroachdb/version v0.0.0-20250509181251-54dac3003410 // indirect
...
replace github.com/cockroachdb/cockroachdb-parser => github.com/spilchen/cockroachdb-parser v0.26.1
